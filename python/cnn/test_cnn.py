...
def text_file(path):
    ...
    np.random.seed(1234)  
    PYTHONHASHSEED = 0
    model_path="C:/Users/91630/OneDrive/Desktop/projext/project-fdia/server/python/cnn/regression_model_cnn.h5"
    ...
    truth_df = pd.read_csv("C:/Users/91630/OneDrive\Desktop/projext/FDIA-PdM-master/Datasets/Attacked test data/True/RUL.txt", sep=" ", header=None)
